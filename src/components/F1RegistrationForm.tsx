            ...
            >
              {isSubmitting ? (
                <span className="flex items-center justify-center gap-2.5">
                  ...
                  {t("f1:registration.processingRegistration")}
                </span>
              ) : (
                <span className="flex items-center justify-center gap-2.5">
                  <CheckCircle className="w-[18px] h-[18px]" />
                  {t("f1:payment.registerCash")}
                </span>
              )}
            </button>

            <p className="text-center text-[11px] text-theme-text-secondary mt-3 leading-relaxed">
              {t("f1:registration.dataProtected")}
            </p>
          </form>
        </div>
      </section>
...
const F1RegistrationForm = React.memo(function F1RegistrationForm() {
  return <F1RegistrationFormInner />;
});
