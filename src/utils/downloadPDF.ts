  ...
  try {
    ...
    if (isProblematicWebView) {
      ...
      try {
        ...
        throw new Error(
          "Za preuzimanje PDF-a, molimo otvorite ovaj link u vašem web browser-u (Chrome, Safari, Firefox) umjesto u aplikaciji."
        );
      }
    }
    ...
    if (isProblematicWebView) {
      throw new Error(
        "PDF se ne može automatski preuzeti u ovoj aplikaciji. Molimo otvorite link u web browser-u ili kontaktirajte nas na muhamed.musa1994@gmail.com za uputstva."
      );
    }
