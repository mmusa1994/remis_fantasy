import PrizesGallery, { Prize } from '@/components/shared/PrizesGallery'

const premierLeaguePrizes: Prize[] = [
  {
    id: 1,
...
export default function NagradePage() {
  return (
    <div className="min-h-screen">
      <PrizesGallery 
        prizes={premierLeaguePrizes}
        leagueFilter="premier"
        title="Premier League Nagrade"
        subtitle="Osvajaj nevjerovatne nagrade tokom cijele Premier League sezone!"
      />
    </div>
  )
}