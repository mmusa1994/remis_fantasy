                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {profile.email_verified && (
                        <FaCheckCircle className="w-4 h-4 text-green-500" title={t('verified')} />
                      )}
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className={`w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700`}>
                    <div 
                      ...
                      style={{ width: `${Math.max(10, (usage.remaining / usage.total) * 100)}%` }}
                    />
                  </div>
            ...
            <div className={`rounded-xl border ${
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  disabled
                >
                  <FaHistory className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`} />
