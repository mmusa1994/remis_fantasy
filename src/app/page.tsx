...
import { Gamepad2, Trophy, Zap, DollarSign, Calendar, Users, Star } from 'lucide-react'
    ...
    <main className={`w-full min-h-screen overflow-x-hidden ${
      ...
      <section className="relative overflow-hidden mobile-nav-adjust pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          {/* Logo */}
          <div className={`w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 mx-auto mb-8 md:mb-12 rounded-full flex items-center justify-center ${
            theme === 'dark' 
          ...
          <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black mb-6 md:mb-8 leading-none ${
            theme === 'dark' ? 'text-white' : 'text-gray-800'
          }`}>
            REMIS Fantasy
            <span className={`block text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl mt-2 md:mt-4 font-normal ${
          ...
          <p className={`text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed mb-12 md:mb-16 max-w-4xl mx-auto ${
                ...
                {league.available ? (
                  <Link href={league.href} className="block">
                    ...
                    <div className={`inline-flex items-center text-sm font-semibold ${
                      league.title === 'Premier League' ? 'text-purple-500' :
                      league.title === 'Champions League' ? 'text-blue-500' : 'text-red-500'
            ...
            {[
              ...
              >
                <div className="mb-2 flex justify-center">
                  <stat.icon className={`w-8 h-8 ${theme === 'dark' ? 'text-orange-400' : 'text-orange-600'}`} />
                </div>
