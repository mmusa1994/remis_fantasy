  ...
  return (
    <div className="min-h-screen bg-theme-background py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          >
            {t(
              ...
              "Choose the perfect plan for your fantasy sports journey. Upgrade or downgrade at any time."
            )}
          </p>
        </div>
          ...
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`relative h-full rounded-3xl border backdrop-blur-lg transition-all duration-500 transform group-hover:scale-105 group-hover:shadow-2xl ${getPlanColor(
                    plan.name,
                    isCurrentPlan
                  )} ${
                    theme === "dark"
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${getPlanGradient(
                      plan.name
                    )} opacity-30 group-hover:opacity-50 transition-opacity duration-500 rounded-3xl`}
                  />
                  ...
                  <div className="relative z-10 p-6 sm:p-8 h-full flex flex-col">
                    ...
                    <div className="text-center mb-8">
                      ...
                      >
                        {plan.description ||
                          t("planDescription", "Perfect plan for your needs")}
                      </p>
                    </div>
                        ...
                        <div>
                          ...
                          >
                            {plan.ai_queries_limit === -1
                              ...
                              : t("aiQueriesLimit", "{{count}} AI Queries", {
                                  count: plan.ai_queries_limit,
                                })}
                          </div>
                          <div
                            className={`text-xs ${
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-xl font-semibold text-sm transition-all duration-300 flex items-center justify-center shadow-lg relative overflow-hidden group/button ${
                        ...
                        isFree && !isCurrentPlan && !isProcessing
        ...
        <div
          className={`text-center mt-16 p-8 rounded-3xl border backdrop-blur-lg relative overflow-hidden ${
            theme === "dark"
        ...
        >
          ...
          <div className="relative">
            ...
            >
              {t(
                "helpDescription",
                "Our support team is here to help you find the perfect plan for your fantasy journey."
              )}
            </p>
            <a
